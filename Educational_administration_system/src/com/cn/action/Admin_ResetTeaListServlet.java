...
public class Admin_ResetTeaListServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageBean pageBean = tblStuAndTeaBiz.teaCourseViewByPageFun(pageNum, 10);
		
		request.setAttribute("pageBean", pageBean);
		request.getRequestDispatcher("admin_ResetTeaList.jsp").forward(request, response);
