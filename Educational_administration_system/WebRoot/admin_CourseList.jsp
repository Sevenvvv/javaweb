		...
		<div class="main">
			<div class="box">
				...
				<div class="Rshow">
					<div class="stitle">
						<h1>课程信息管理</h1>
						<a href="admin_AddCourse.html" class="btn btn-default">添加课程信息 <span class="glyphicon glyphicon-plus"></span></a>
					</div>
					<div class="showtable">
						<table class="table table-bordered table-striped">
							...
							<c:forEach items="${requestScope.pageBean.lists}" var="course">
								<tr>
									...
									<td>${course.point}</td>
									<td>
										<a href="admin_UpdateCourse.html" class="btn btn-info">修改</a>
