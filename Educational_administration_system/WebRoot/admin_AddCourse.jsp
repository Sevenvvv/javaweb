				...
				<div class="Rshow">
					...
					<div class="updatetable">
						<div>
							...
							<form class="form-horizontal" action="admin_Addcourse" method="post" role="form">
								<div class="from-group">
									<div class="col-sm-2">
										<label for="courseName" class="control-label">课程名称:</label>
									</div>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="courseName" id="courseName" value="${tblCourse.courseName}"/>
									</div>
								</div>
								<div class="from-group">
									<div class="col-sm-2">
								...
								<div class="from-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="courseBegin" id="courseBegin" value="${tblCourse.courseBegin}"/>
									</div>
								</div>
								<div class="from-group">
									<div class="col-sm-2">
								...
								<div class="from-group">
									...
									<div class="col-sm-10">
										<select name="courseType" class="form-control">
											...
											<option value="0" ${tblCourse.courseType == "2"?"selected='selected'":''}>选修</option>
										</select>
									</div>
								</div>
								<div class="from-group">
