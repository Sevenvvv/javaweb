	...
	<body>
		<div class="header">
			...
			<div class="user dropdown">
				<button type="button" class="btn dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>用户名<span class="caret"></span></button>
		...
		<div class="main">
			<div class="box">
				<div class="Lmenu">
					...
					<a href="admin_Setnewpasaword">修改密码<span class="glyphicon glyphicon-edit"></span></a>
					<a href="admin_ResetStulist">账号密码重置<span class="glyphicon glyphicon-repeat"></span></a>
				</div>
				<div class="Rshow">
					<div class="stitle">
						<h1>学生信息管理</h1>
						<a href="admin_AddStudent.html" class="btn btn-default">添加学生信息<span class="glyphicon glyphicon-plus"></span></a>
					</div>
					<div class="showtable">
						<table class="table table-bordered table-striped">
							...
							<c:forEach items="${requestScope.pageBean.lists}" var="student">
								<tr>
									...
									<td>
										<a href="admin_UpdateStudent.html" class="btn btn-info">修改</a>
					...
					<div class="page">
						<div class="pul">
							...
							<ul class="pagination">
								...
								<c:if test="${pageBean.pageNum > 1 }">
									<li><a href="admin_Studentlist?pageNum=${pageBean.pageNum - 1 }">上一页</a></li>
								</c:if>
								<c:forEach begin="1" end="${pageBean.pageCount }" step="1" var="i">
					                <c:if test="${page.pageNum==i }">
					                    <li><a href="admin_Studentlist?pageNum=${i}">${i}</a></li>
					                </c:if>
					                <c:if test="${page.pageNum!=i }">
					                    <li><a href="admin_Studentlist?pageNum=${i}">${i}</a></li>
					                </c:if>
								...
								<c:if test="${pageBean.pageNum < pageBean.pageCount }">
									<li><a href="admin_Studentlist?pageNum=${pageBean.pageNum + 1 }">下一页</a></li>
								</c:if>
							</ul>
						</div>
						</div>
