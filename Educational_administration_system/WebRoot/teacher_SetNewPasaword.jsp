...
<html>
	...
	<body>
		...
		<div class="main">
			<div class="box">
				<div class="Lmenu">
					<a href="teacher_Courselist">课程管理<span class="glyphicon glyphicon-list-alt"></span></a>
					<a href="teacher_SetNewPasaword.jsp" class="btn btn-info active">修改密码<span class="glyphicon glyphicon-edit"></span></a>
				</div>
				<div class="Rshow">
					<div class="stitle">
						<h1>修改密码</h1>
					...
					<div class="updatetable">
						<div>
							...
							<form class="form-horizontal" action="teacher_Setnewpassword" method="post" role="form">
