		...
		<div class="main">
			<div class="box">
				<div class="Lmenu">
					...
					<a href=admin_SetNewPassword.jsp class="btn btn-info active">修改密码<span class="glyphicon glyphicon-edit"></span></a>
				...
				<div class="Rshow">
					...
					<div class="updatetable">
						<div>
							...
							<form class="form-horizontal" action="admin_Setnewpassword" method="post" role="form">
