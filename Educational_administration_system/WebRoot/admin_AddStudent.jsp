				...
				<div class="Rshow">
					...
					<div class="updatetable">
						<div>
							...
							<form class="form-horizontal" action="admin_Addstudent" method="post" role="form">
								<div class="from-group">
									<div class="col-sm-2">
										<label for="studentId" class="control-label">学号:</label>
									</div>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="studentId" id="studentId" value="${tblStudent.studentID}"/>
									</div>
								</div>
								<div class="from-group">
									<div class="col-sm-2">
								...
								<div class="from-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="grade" id="grade" value="${tblStudent.grade}"/>
									</div>
								</div>
								<div class="from-group">
									<div class="col-sm-2">
