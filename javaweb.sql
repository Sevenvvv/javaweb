...
INSERT INTO `admin` VALUES (450,'麻瓜1','123456'),(451,'麻瓜2','123456');
...
INSERT INTO `class` VALUES (1,'17机电一体化',1,1000),(2,'17工程造价',2,1001),(3,'17旅游管理',3,1002),(4,'17电子商务',4,1003),(5,'17会计专业',5,1004),(6,'17商务英语',6,1005),(7,'17软件技术',7,1006),(8,'17室内艺术设计',8,1007),(9,'17传播与策划',9,1008);
...
INSERT INTO `college` VALUES (1,'机电工程学院'),(2,'建筑工程学院'),(3,'旅游学院'),(4,'商学院'),(5,'财经学院'),(6,'国际学院'),(7,'信息工程学院'),(8,'艺术工程学院'),(9,'公共管理学院');
...
INSERT INTO `major` VALUES (1,'机电一体化技术专业',1),(2,'工程造价',2),(3,'旅游管理',3),(4,'电子商务',4),(5,'会计专业',5),(6,'商务英语',6),(7,'软件技术',7),(8,'室内艺术设计专业',8),(9,'传播与策划',9);
...
CREATE TABLE `selectedcourse` (
  ...
  CONSTRAINT `selectedcourse_ibfk_2` FOREIGN KEY (`studentID`) REFERENCES `student` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `selectedcourse` VALUES (1,1702040000,NULL),(2,1702040001,NULL),(3,1702040002,NULL),(4,1702040003,NULL),(5,1702040004,NULL),(6,1702040005,NULL),(7,1702040006,NULL),(8,1702040007,NULL),(9,1702040008,NULL);
...
CREATE TABLE `student` (
  ...
  `sPasswaord` varchar(11) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `classID` (`classID`),
  CONSTRAINT `student_ibfk_1` FOREIGN KEY (`classID`) REFERENCES `class` (`classID`)
) ENGINE=InnoDB AUTO_INCREMENT=1702040009 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `student` VALUES (1702040000,1702040001,'张三','1','1999-01-02','2017-09-15',1,'123456'),(1702040001,1702040001,'李四','1','1999-01-01','2017-09-15',2,'123456'),(1702040002,1702040001,'王五','1','1999-01-03','2017-09-15',3,'123456'),(1702040003,1702040001,'赵四','1','1999-01-04','2017-09-15',4,'123456'),(1702040004,1702040001,'李明','0','1999-01-05','2017-09-15',5,'123456'),(1702040005,1702040001,'李华','0','1999-01-06','2017-09-15',6,'123456'),(1702040006,1702040001,'张学友','1','1999-01-07','2017-09-15',7,'123456'),(1702040007,1702040001,'刘德华','1','1999-01-08','2017-09-15',8,'123456'),(1702040008,1702040001,'黎明','1','1999-01-09','2017-09-15',9,'123456');
...
INSERT INTO `teacher` VALUES (1000,12001,'杨志标','1','1980-01-02','研究生','教授','2017-01-02',1,'123456'),(1001,12002,'宇哥','1','1980-01-01','本科','教授','2017-01-01',2,'123456'),(1002,12003,'郑超凡','1','1980-01-03','本科','教授','2017-01-03',3,'123456'),(1003,12004,'雷应忠','1','1980-01-04','本科','教授','2017-01-04',4,'123456'),(1004,12005,'韦寿海','1','1980-01-05','本科','教授','2017-01-05',5,'123456'),(1005,12006,'李保龙','0','1980-01-06','初中','助教','2017-01-06',6,'123456'),(1006,12007,'杨德仁','0','1980-01-07','本科','讲师','2017-01-07',7,'123456'),(1007,12008,'李茗','0','1980-01-08','本科','副教授','2017-01-08',8,'123456'),(1008,12009,'李丽丽','0','1980-01-09','本科','教授','2017-01-09',9,'123456');
...
-- Dump completed on 2018-07-09 21:36:27
